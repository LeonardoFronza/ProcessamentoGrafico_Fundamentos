 ...
 *
 * Adaptado por: LEONARDO Baptista Queiroz
 *
 * Disciplinas:
...
int main()
{
	...
	GLFWwindow *window = glfwCreateWindow(WIDTH, HEIGHT, "L2_Ex02 - Ortho(0,800,600,0) -- LEONARDO FRONZA", nullptr, nullptr);
	if (!window)
	{
	...
	while (!glfwWindowShouldClose(window))
	{
		// Calcula e mostra o FPS na barra de título
		{
			...
			if (title_countdown_s <= 0.0 && elapsed_s > 0.0)
			{
				...
				char tmp[256];
				sprintf(tmp, "L2_Ex02 - Ortho(0,800,600,0) -- LEONARDO FRONZA\tFPS %.2lf", fps);
